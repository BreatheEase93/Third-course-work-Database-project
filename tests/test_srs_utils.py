...
class TestSalaryFormatTranslation:
    ...
    def test_salary_rub(self):
        ...
        salary_data = {"currency": "RUR", "from": 50000, "to": 70000}
    ...
    def test_salary_usd(self):
        ...
        salary_data = {"currency": "USD", "from": 1000, "to": 1500}
    ...
    def test_salary_eur(self):
        ...
        salary_data = {"currency": "EUR", "from": 2000, "to": 3000}
    ...
    def test_salary_only_from(self):
        ...
        salary_data = {"currency": "RUR", "from": 80000, "to": None}
    ...
    def test_salary_only_to(self):
        ...
        salary_data = {"currency": "RUR", "from": None, "to": 120000}
    ...
    def test_salary_no_range(self):
        ...
        salary_data = {"currency": "RUR", "from": None, "to": None}
